...
def answer_trivia(
    input_file,
    output_file,
    model_name="TheBloke/Trurl-2-7B-GPTQ",
    file_name="szymonrucinski/Curie-7B-v1",
    batch_size=1,
    max_new_tokens=256,
    temperature=0.1,
    top_k=25,
    ...
    prompt_template = """<s>[INST] <<SYS>>
        ...
        Teraz twoje pytanie: {question} [/INST]"""
...
if __name__ == "__main__":
    answer_trivia(
        ...
        output_file='data/output/pl/triva_qa_polish_curie.csv',
        batch_size=1,
        temperature=0.1,
        max_new_tokens=256
    )